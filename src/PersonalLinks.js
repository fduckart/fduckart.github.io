        ...
        return (
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="https://github.com/fduckart" target="_duckartgithub">
                ...
                <li className="nav-item">
                    <a className="nav-link" href="./files/fduckart-resume.pdf" target="_fduckartresume">
